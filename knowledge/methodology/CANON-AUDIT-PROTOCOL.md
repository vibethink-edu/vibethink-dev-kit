...
### §8.8 — The mirror false-RED: a gate must not block clean work by mislabeling an absent inherited dependency as a content defect *(DRAFT — pending Principal Architect seal)*
