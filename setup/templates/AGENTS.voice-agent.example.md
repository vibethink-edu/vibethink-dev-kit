<!--
========================================================================
  EXAMPLE — NOT UNIVERSAL AUTHORITY
========================================================================
  This is a CONCRETE PROJECT EXAMPLE of an `AGENTS.md` (a real voice-agent
  app: "Andrés Cántor", React/Vite/Gemini/ElevenLabs). It is level-3
  product content, kept here only as a reference of what a project-specific
  AGENTS.md looks like.

  - The vendor-neutral authority lives in
    `knowledge/ai-agents/AGENTS_UNIVERSAL.md` + `CANON-CROSS-AGENT-CONTEXT-LAYERING.md`.
  - For a blank starting point use `setup/templates/AGENTS.md.template`.
  - Do NOT treat anything below as a universal rule — the stack, vocabulary,
    and constraints here belong to one specific product.
========================================================================
-->
...
- El PAT NUNCA va hardcodeado aquí: vive en `.env` / credential manager. (El token que estaba en esta línea fue REVOCADO 2026-05-22 por quedar expuesto en el repo.)
